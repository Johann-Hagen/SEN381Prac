...
{
    class Updater : CRUD // Class that will execute UPDATE procedure
    {
        
        private SqlConnection conn;
        public Updater(SqlConnection conn)
        {
            this.conn = conn;
        }
        ...
        public void executeProcedure(string table, string whereClause)
        {
            using (SqlConnection conn = new SqlConnection(Conn.ToString()))
            {
                switch (table)
                {
                    ...
                    case "tblTechnician":
                        conn.Open();
                        SqlCommand command1 = new SqlCommand("UpdateTechnician", conn);
                    ...
                    case "tblProduct":
                        conn.Open();
                        SqlCommand command2 = new SqlCommand("UpdateProduct", conn);
                    ...
                    case "tblService":
                        conn.Open();
                        SqlCommand command3 = new SqlCommand("UpdateService", conn);
                    ...
                    case "tblContract":
                        conn.Open();
                        SqlCommand command4 = new SqlCommand("UpdateContract", conn);
                    ...
                    case "tblClient":
                        conn.Open();
                        SqlCommand command5 = new SqlCommand("UpdateClient", conn);
                    ...
                    case "tblBillingHistory":
                        conn.Open();
                        SqlCommand command6 = new SqlCommand("UpdateClient", conn);
